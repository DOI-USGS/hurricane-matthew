...
visualize.matthew_map <- function(viz){
  ...
  g.legend <- xml_add_child(svg, 'g', id='precip-legend','class'='legend', transform='translate(530,220)')
  ...
  xml_add_child(svg, 'text', ' ', id='timestamp-text', class='time-text', x='170', y='500', 'text-anchor'="middle")
